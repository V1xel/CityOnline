...
UNREALROOTPATH = /home/v1xel/Documents/Tools/UnrealEngine
GAMEPROJECTFILE =/home/v1xel/Documents/Projects/CityOnline/CO.uproject
...
TARGETS = \
	...
	CO-Linux-Shipping  \
	CO \
	COEditor-Linux-Debug  \
	COEditor-Linux-DebugGame  \
	COEditor-Linux-Test  \
	COEditor-Linux-Shipping  \
	COEditor \
...
CO-Linux-Debug:
	 $(PROJECTBUILD) CO Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CO-Linux-DebugGame:
	 $(PROJECTBUILD) CO Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CO-Linux-Test:
	 $(PROJECTBUILD) CO Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CO-Linux-Shipping:
	 $(PROJECTBUILD) CO Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CO:
	 $(PROJECTBUILD) CO Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

COEditor-Linux-Debug:
	 $(PROJECTBUILD) COEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

COEditor-Linux-DebugGame:
	 $(PROJECTBUILD) COEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

COEditor-Linux-Test:
	 $(PROJECTBUILD) COEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

COEditor-Linux-Shipping:
	 $(PROJECTBUILD) COEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

COEditor:
	 $(PROJECTBUILD) COEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
